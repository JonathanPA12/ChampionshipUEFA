...
<header class="fixed-top">
		...
		<div class="navbar navbar-dark bg-dark">
			<div class="container">
				<a href="../../php/logout.php" class="navbar-brand d-flex align-items-center">
					<img src="../../img/uefaIcon.png" alt="" class="img-fluid card-img-top" >
					<strong class="p-2">LOGOUT</strong>
				</a>   
                <a 	
                    href="crearEquipo.html"
					class="nav-link "
					role="button"
					aria-expanded="false"
                    style="color:#ffffff;"
    ...
    <main>
        <div class="container my-5">
            <div class="row my-5">
                <div class="col-12">
                    <form action="buscadorEquipos.php" method="POST" autocomplete="off">
                        <input type="text" name="pais" placeholder="pais a buscar">
                        <button type="submit" class="col-1 btn btn-primary">Consultar</button>
                    </form>
                    <?php
                        if(isset($_POST['pais'])){
                            require_once "connect.php";
                            require_once "procesos/buscarEquipos.php";
                        }
                    ?>
                </div>
            </div>
