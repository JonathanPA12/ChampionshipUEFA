...
<head>
	...
	<title>Buscar Equipos Nombre</title>
</head>
<body>
        ...
        <div class="container my-5">
            <div class="row my-5">
                <div class="col-12 mt-5">
                    <form action="buscadorEquipoNombre.php" method="POST" autocomplete="off">
						<label for="equipo" class="form-label">Nombre del Equipo</label>
						<div class="col-12 col-md-3 mb-3 mt-5">
							<label for="equipo" class="form-label">Equipo</label>
							<select name="nombreE" class="form-select" id="select_box">
								<?php 
                    ...
                    <?php
                        if(isset($_POST['nombreE'])){
                            require_once "../connect.php";
                            require_once "../equipos/buscarEquipoNombre.php";
                        }
                    ?>
                </div>
            </div>
