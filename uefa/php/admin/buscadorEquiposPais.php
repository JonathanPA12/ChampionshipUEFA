<?php
	...
	$query = "SELECT nombre FROM Paises ORDER BY nombre ASC";
...
<head>
	...
	<title>Buscar Equipos País</title>
</head>
<body>
        ...
        <div class="container my-5">
            <div class="row my-5">
                <div class="col-12 mt-5">
                    <form action="buscadorEquiposPais.php" method="POST" autocomplete="off">
						<div class="col-12 col-md-3 mb-3 mt-5">
							<label for="equipo" class="form-label">País</label>
							<select name="pais" class="form-select" id="select_box">
								<?php 
                        ...
                        <button type="submit" class="col-1 btn btn-primary">Consultar</button>
                    </form>
                    <?php
                        if(isset($_POST['pais'])){
                            require_once "../connect.php";
                            require_once "../equipos/buscarEquiposPais.php";
                        }
                    ?>
                </div>
            </div>
